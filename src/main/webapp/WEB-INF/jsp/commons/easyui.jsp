...
<script type="text/javascript" src="<c:url value="/resources/jquery-easyui-1.3/jquery.easyui.min.js"/>" ></script>
<script type="text/javascript" src="<c:url value="/resources/jquery-easyui-1.3/locale/easyui-lang-zh_CN.js"/>"></script>